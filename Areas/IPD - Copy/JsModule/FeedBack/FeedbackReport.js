            ...
            if (Object.keys(data.ResultSet).length > 0) {
                ...
                if (Object.keys(data.ResultSet.Table1).length > 0) {
                    ...
                    $.each(data.ResultSet.Table1, function (key, val) {
                        ...
                        tbody += "<td style='text-align:center;'>" + val.Freq + "</td>";
                    ...
                    strQheader += "<th style='background-color:#c2dff9'>Freq.</th>";
                ...
                if (Object.keys(data.ResultSet.Table2).length > 0) {
                   var strDoctor;
                    ...
                    strDoctor += "<th style='background-color:#c2dff9'>Freq.</th>";
                ...
                if (Object.keys(data.ResultSet.Table3).length > 0) {
                    ...
                    strNurse += "<th style='background-color:#c2dff9'>Freq.</th>";
                ...
                if (Object.keys(data.ResultSet.Table4).length > 0) {
                    ...
                    strFloor += "<th style='background-color:#c2dff9'>Freq.</th>";
