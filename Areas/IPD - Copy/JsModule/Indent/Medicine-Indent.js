...
$(document).ready(function () {
    ...
    $('#tblAdmittedIPDPatient tbody').on('click', '.getPatient', function () {
        ...
        _ptmobileNo = $(this).data('ptcontactno');
